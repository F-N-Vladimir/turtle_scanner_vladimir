...
class TurtleScannerNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("TurtleScannerNode démarré - Balayage + Détection activés")
        ...
        self.Kp_ang = 2.5
        self.Kp_lin = 1.0
        self.detection_radius = 1.5          # ← rayon de détection (comme demandé)

        # Waypoints serpentin (Partie 3)
        self.waypoints = []
        ...
        self.detected_pub = self.create_publisher(Bool, '/target_detected', 10)   # ← nouveau
    ...
    def scan_step(self):
        ...
        # === DÉTECTION DE LA CIBLE (Partie 4) ===
